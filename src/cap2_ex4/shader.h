...
/*
	Uniform& operator =(const Uniform &un) {
		if (this != &un) {
			this->name = un.name;
			this->location = un.location;
		}
		return *this;
	}*/
};
...
/*
	Attribute& operator =(const Attribute &attr) {
		if (this != &attr) {
			...
			this->type = attr.type;
			this->usage = attr.usage;
			this->name = attr.name;
			this->vertexSize = attr.vertexSize;
			this->vertexComponentType = attr.vertexComponentType;
			this->bufferId = attr.bufferId; 
		}
		return *this;
	}*/
