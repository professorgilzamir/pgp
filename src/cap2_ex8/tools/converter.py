...
def write_xyz(file, varname, sufix, list):
...
def write_index(file, varname, sufix, list):
...
def generate(file, varname):
	write_xyz(file, varname, "vertices", vertices)
	write_xyz(file, varname, "normals", normals)
	write_index(file, varname, "faceindex", face_index)
	write_index(file, varname, "normalindex", normal_index)
