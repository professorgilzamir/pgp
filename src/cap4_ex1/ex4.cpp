...
int inicializar(void)
{
	...
	vabID = createVertexBuffer();
	setVertexDataBuffer(vabID, cubo_vertices, sizeof(cubo_vertices));
	...
	nabID = createVertexBuffer();
	setVertexDataBuffer(nabID, normais, sizeof(normais));

	eabID = createElementBuffer();
	setElementDataBuffer(eabID, cubo_faceindex, sizeof(cubo_faceindex));
